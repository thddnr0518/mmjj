	...
	<tbody>
		<c:forEach items="${list }" var="cartList">
			...
			<tr>
				...
				<td>
					<input type="number" id="orderCnt" name="orderCnt" data-orderCnt="30">
					<input type="text" id="productNo" name="productNo" data-productNo="50">
				</td>
				<td>
...
$(document).ready(function(){
	...
	$("span").data("productNo","123");
	$("span").data("orderCnt","456");

	var productNo = $("span").data("productNo");
	var orderCnt = $("span").data("orderCnt");
