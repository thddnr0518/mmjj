	...
	<div class="customBoard">
	    <div class="panel panel-default">
	      ...
	      <div class="panel-body">
			...
			<form action="${contextPath}/board/modify" method="post" role="form" id="modifyForm">
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="3" name="content" maxlength="333">${board.content }</textarea>
				</div>
