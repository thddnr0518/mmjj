...
<%-- 
<!-- 모달 닫기 -->
<div id="custom_modal" class="custom_modal" style="background-color: rgba(0,0,0,1);">
	<!-- 모달 닫기 -->
	<span id="custom_modalClose" class="custom_modalClose" onclick="go_home();">&times;</span>
	<!-- 로그인 모달 -->
	<div id="loginForm" class="custom_modal-content">
		<form action="${contextPath }/login" id="login" method="post" name="login">
			...
			<div style="margin: 0 auto; margin-top: 10px; margin-bottom: 30px;text-align: center; width: 50%;">
				<div>
			        <span class="box">
			            <input type="text" id="inputID" name="inputid" class="int" maxlength="15" placeholder="아이디" value="admin0">
			        </span>
		        </div>
		        <div style="margin-top: 20px;">
			        <span class="box">
			            <input type="password" id="inputPWD" name="inputpwd" class="int" maxlength="15" placeholder="비밀번호" value="pw00">
			        </span>
			...
			<div style="margin: 20px;">
				...
				<div style="text-align:center; display: flex;">
					<span style="flex: 1; font-size: 20px">회원이 아니신가요..? 왜 회원이 아니시죠? <span class="clck" onclick="modal_join();"> 회원가입</span>
				</div>
			</div>
				...
				<div class="FormSize">
					...
					<div>
				        ...
				        <span class="box int_pass">
				            <input type="text" id="userid" name="userid" class="int" maxlength="20" autocomplete="off" autofocus="autofocus" value="test1234">
				    ...
				    <div>
				        <h3><label for="userpw">비밀번호</label></h3>
				         <span class="box int_pass">
				            <input type="password" id="userpw" name="userpw" class="int" maxlength="16" value="password">
				    ...
				    <div>
				        <h3><label for="pwdChk">비밀번호 재확인</label></h3>
				         <span class="box int_pass">
				            <input type="password" id="pwdChk" name="pwdChk" class="int" maxlength="16" disabled="disabled" value="password">
				    ...
				    <div>
				        ...
				        <span class="box">
				            <input type="text" id="nickName" name="nickName" class="int" maxlength="10" autocomplete="off" value="testNick">
				        </span>
				        <span class="error_next_box"></span>
				    </div>
				    <!-- EMAIL -->
				        ...
				        <div id="email_wrap">
				        	<div id="email_1">
						        <span class="box">
						            <input type="text" id="email1" name="email1" class="int" maxlength="30" placeholder="email ID" autocomplete="off"value="test">
						        </span>
					        </div>
					        <div id="email_2">
					        	<span class="box">
						    ...
						    <div id="email_3">
						    	<span class="box">
							        <input id="email2" name="email2" class="int" maxlength="30" list="domains" placeholder="입력or선택" autocomplete="off"value="naver.com">
							        <datalist id="domains">
				    ...
				    <div>
				        ...
				        <span class="box">
				            <input type="text" id="userName" name="userName" class="int" maxlength="10" autocomplete="off"value="테스트">
				        </span>
				        <span class="error_next_box"></span>
				    </div>
				    <!-- BIRTH -->
				    <div>
				        ...
				        <div id="bir_wrap">
				            ...
				            <div id="bir_yy">
				                <span class="box">
				                    <input type="text" id="yy" name="yy" class="int" maxlength="4" placeholder="년(4자)" autocomplete="off"value="1995">
				                </span>
				            </div>
				            <!-- BIRTH_MM -->
				            <div id="bir_mm">
				            ...
				            <div id="bir_dd">
				                <span class="box">
				                    <input type="text" id="dd" name="dd" class="int" maxlength="2" placeholder="일" autocomplete="off" value="20">
				                </span>
				            </div>
				        </div>
				        <span class="error_next_box"></span>    
				    ...
				    <div>
				        ...
				        <div id="road_wrap">
						    ...
						    <div id="road-B">
						        <span class="box">
									<input type="text" id="sample4_detailAddress" placeholder="상세주소" name="addr2"class="int" autocomplete="off" value="한경빌딩">
								</span>
							</div>
				        </div>
				    ...
				    <div>
				        ...
				        <span class="box">
				            <input type="tel" id="phone" class="int" name="phone" maxlength="12" placeholder="전화번호 입력" autocomplete="off" value="0100100100">
				        </span>
				        <span class="error_next_box"></span>    
				    </div>
