...
var replyService = (function() {
	...
	function remove(rno, replyer, callback, error) {
		...
		console.log("js // removo.....");
		console.log("js // rno....." + rno);
		console.log("js // replyer....." + replyer);
		
		$.ajax({
			type : "delete",
			url : rno.contextPath + "/replies/" + rno.rno,
			data: JSON.stringify({rno:rno.rno, replyer:replyer}),
			contentType: "application/json; charset=utf-8",
	...
	function get(rno, callback, error) {
		...
		$.get(rno.contextPath + "/replies/" + rno.rno + ".json", function(result) {
